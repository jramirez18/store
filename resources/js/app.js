...
//despues almacenamos en un objeto store del windows, para que este disponible en todos mis archivos de javascriipt  
...
Vue.component('products-couter-component', require('./components/shopping_cart/CounterComponent.vue').default);
