...
class PaymentsController extends Controller
{
    ...
    public function pay(Request $request)
    {
       ...
       //creamos un nuevo objeto de la clase paypal
       $paypal= new PayPal();

       //obtenemos una respuesta a nuestra solicitud de cobro todavia no tenemso un autorizacion 
    ...
    if($response->statusCode == 200){//si es =200 la compra se realizo adecuadamente
